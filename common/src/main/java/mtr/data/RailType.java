...
public enum RailType implements IGui {
    ...
    BARRIER(700, TERRACOTTA_RED, false, true, true, RailSlopeStyle.CURVE),
    BEDROCK(800, TERRACOTTA_CYAN, false, true, true, RailSlopeStyle.CURVE),
    NETHERITE(450, NETHER, false, true, true, RailSlopeStyle.CURVE),
    PURPUR(500, COLOR_MAGENTA, false, true, true, RailSlopeStyle.CURVE),
    REINFORCED_DEEPSLATE(600, TERRACOTTA_LIGHT_BLUE, false, true, true, RailSlopeStyle.CURVE);
    ...
    RailType(int speedLimit, MaterialColor MaterialColor, boolean hasSavedRail, boolean canAccelerate, boolean hasSignal, RailSlopeStyle railSlopeStyle) {
        ...
        this.maxBlocksPerTick = speedLimit / 3.6F / 20.0F;
        this.color = MaterialColor.col| ARGB_BLACK;
