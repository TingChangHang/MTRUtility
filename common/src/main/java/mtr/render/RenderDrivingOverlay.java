...
public class RenderDrivingOverlay implements IGui {
	...
	public static void render(PoseStack matrices) {
		...
		client.font.drawShadow(matrices, "N", startX + 5.5F, startY + 7.5F, doorValue == 0 && accelerationSign == 0 ? ARGB_WHITE : ARGB_GRAY);
		client.font.drawShadow(matrices, "P1", startX + 25.5F, startY + 7.5F, doorValue == 0 && accelerationSign == 1 ? ARGB_WHITE : ARGB_GRAY);
		client.font.drawShadow(matrices, "P2", startX + 45.5F, startY + 7.5F, doorValue == 0 && accelerationSign == 2 ? ARGB_WHITE : ARGB_GRAY);
		client.font.drawShadow(matrices, "P3", startX + 65.5F, startY + 7.5F, doorValue == 0 && accelerationSign == 3 ? ARGB_WHITE : ARGB_GRAY);
		client.font.drawShadow(matrices, "P4", startX + 85.5F, startY + 7.5F, doorValue == 0 && accelerationSign == 4 ? ARGB_WHITE : ARGB_GRAY);

		client.font.drawShadow(matrices, "→←", startX + 125.5F, startY + 7.5F, speed == 0 && doorValue == 0 ? ARGB_WHITE : ARGB_GRAY);
		...
		client.font.drawShadow(matrices, "←→", startX + 165.5F, startY + 7.5F, speed == 0 && doorValue == 1 ? ARGB_WHITE : ARGB_GRAY);
